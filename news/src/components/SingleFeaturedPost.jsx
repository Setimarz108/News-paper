        ...
        return (
            ...
            <div className="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                 ...
                 <div className="col p-4 d-flex flex-column position-static">
                    ...
                    <div className="mb-1 text-muted">{/* {format(new Date(this?.props?.article?.publishedAt), "MMM dd")} */}</div>
                ...
                <div className="col-auto d-lg-block">
                    <img className="card-img-right flex-auto d-none d-md-block"  alt="Thumbnail [200x250]" style={{width: "200px", height: "250px"}} src={this?.props?.article?.urlToImage}/>  {/* <img style={{width: "200px" , height:"250px", objectFit: "cover"}} src={this.props.article.urlToImage} alt="" /> */}
                </div>
            </div>
